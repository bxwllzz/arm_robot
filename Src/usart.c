...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspInit 0 */
    ...
    PC11     ------> UART4_RX 
    */
    GPIO_InitStruct.Pin = RS485_3_TX_Pin|RS485_3_RX_Pin;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX 
    */
    HAL_GPIO_DeInit(GPIOC, RS485_3_TX_Pin|RS485_3_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD5     ------> USART2_TX 
    */
    HAL_GPIO_DeInit(RS485_1_RX_GPIO_Port, RS485_1_RX_Pin);

    HAL_GPIO_DeInit(RS485_1_TX_GPIO_Port, RS485_1_TX_Pin);
